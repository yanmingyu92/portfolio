# Medium upload-ready draft — The Contradictions Your Validator Can't See
...
2. Title: The Contradictions Your Validator Can't See
...
4. Set the canonical link (SEO): Story settings -> Advanced settings ->
   "This story was originally published elsewhere" -> https://jaimeyan.com/blog/graph-constrained-validation-cdisc-oncology.html
5. Tags (Medium allows 5): cdisc, sdtm, shacl, recist, clinical-data-validation
6. Preview, then Publish.

## Alternative: importer (fast, but no table fidelity)

- https://medium.com/p/import with https://jaimeyan.com/blog/graph-constrained-validation-cdisc-oncology.html — sets canonical
  automatically, but Medium flattens HTML tables; prefer the paste path above
  for this series.

---

Canonical: https://jaimeyan.com/blog/graph-constrained-validation-cdisc-oncology.html
...
Figure: [CAVE-Onc pipeline from XPT domains through the RDF graph to the L1 SHACL layer, the L3 agent, and the Merkle-chained audit store](https://jaimeyan.com/figures/graph-constrained-validation-cdisc-oncology-arch.svg)
