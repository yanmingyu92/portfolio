# Medium upload-ready draft — Statistical Computing Environments: From SAS VM to Cloud SCE
...
2. Title: Statistical Computing Environments: From SAS VM to Cloud SCE
...
4. Set the canonical link (SEO): Story settings -> Advanced settings ->
   "This story was originally published elsewhere" -> https://jaimeyan.com/blog/sce-statistical-computing-environment-guide.html
5. Tags (Medium allows 5): clinical-sas, sce, git, cloud, gxp
6. Preview, then Publish.

## Alternative: importer (fast, but no table fidelity)

- https://medium.com/p/import with https://jaimeyan.com/blog/sce-statistical-computing-environment-guide.html — sets canonical
  automatically, but Medium flattens HTML tables; prefer the paste path above
  for this series.

---

Canonical: https://jaimeyan.com/blog/sce-statistical-computing-environment-guide.html
Video: https://youtu.be/KuCVygk_Dn8
...
**Series navigation** — Previous: [Part 0: The Clinical SP Bootcamp roadmap](https://jaimeyan.com/blog/clinical-sp-bootcamp-roadmap.html) · Next: Part 12: Git for SAS Programmers

In numbering order the series continues with [Part 2: the ADSL derivation walkthrough](https://jaimeyan.com/blog/adsl-derivation-tutorial-trtstdt.html). For the AI side of everything above, see [AI coding assistants for clinical programmers](https://jaimeyan.com/blog/ai-coding-assistants-sas-gxp.html); for keeping a validated SAS library untouched while modernizing around it, read [non-destructive legacy modernization](https://jaimeyan.com/blog/non-destructive-legacy-modernization-sas.html).
