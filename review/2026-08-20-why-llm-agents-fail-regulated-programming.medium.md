# Medium upload-ready draft — Why LLM Agents Fail at Regulated Programming — the Process-DAG Fix
...
2. Title: Why LLM Agents Fail at Regulated Programming — the Process-DAG Fix
...
4. Set the canonical link (SEO): Story settings -> Advanced settings ->
   "This story was originally published elsewhere" -> https://jaimeyan.com/blog/why-llm-agents-fail-regulated-programming.html
5. Tags (Medium allows 5): llm-agents, clinical-trials, gxp, statistical-programming
6. Preview, then Publish.

## Alternative: importer (fast, but no table fidelity)

- https://medium.com/p/import with https://jaimeyan.com/blog/why-llm-agents-fail-regulated-programming.html — sets canonical
...
Figure: [Process DAG for ADaM ADSL derivation: typed nodes from ingest to export, connected by versioned .rds artifacts, with deterministic validation gates](https://jaimeyan.com/figures/why-llm-agents-fail-regulated-programming-dag.svg)
...
Full technical details are in the [GxP-Agent preprint](https://jaimeyan.com/papers/gxp-agent.html) (arXiv) and the peer-reviewed [ClinAgent methodology paper](https://jaimeyan.com/papers/clinagent-methodology.html) in *Biology Methods and Protocols*.
