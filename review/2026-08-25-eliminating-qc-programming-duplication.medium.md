# Medium upload-ready draft — Double Programming Without the Duplication: AI-Generated QC Code
...
2. Title: Double Programming Without the Duplication: AI-Generated QC Code
...
4. Set the canonical link (SEO): Story settings -> Advanced settings ->
   "This story was originally published elsewhere" -> https://jaimeyan.com/blog/eliminating-qc-programming-duplication.html
5. Tags (Medium allows 5): qc-programming, clinical-trials, llm-agents, adam, validation
6. Preview, then Publish.

## Alternative: importer (fast, but no table fidelity)

- https://medium.com/p/import with https://jaimeyan.com/blog/eliminating-qc-programming-duplication.html — sets canonical
...
Figure: [The four-gate Decision Router routing datasets to full AI generation, AI with enhanced review, or manual QC](https://jaimeyan.com/figures/eliminating-qc-programming-duplication-router.svg)
...
Full details, including the decision router breakdown and the complete code review rule reference, are in the [full paper](https://jaimeyan.com/papers/pharmasug-2026-ai-201.html) from PharmaSUG 2026. The experiment code is public at [github.com/yanmingyu92/ai-qc-code-generation](https://github.com/yanmingyu92/ai-qc-code-generation).
