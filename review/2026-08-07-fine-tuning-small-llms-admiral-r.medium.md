# Medium import draft — Fine-Tuning LLaMA 3.1 8B for Admiral R Code: From 0.36 to 0.82
...
2. Paste the canonical URL: https://jaimeyan.com/blog/fine-tuning-small-llms-admiral-r.html
...
5. Add tags manually (Medium allows 5): fine-tuning, lora, admiral, adam, small-llms
