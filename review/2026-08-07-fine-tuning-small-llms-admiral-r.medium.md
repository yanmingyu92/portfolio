# Medium upload-ready draft — Fine-Tuning Llama 3.1 8B for admiral R Code: From 0.36 to 0.82
...
2. Title: Fine-Tuning Llama 3.1 8B for admiral R Code: From 0.36 to 0.82
...
4. Set the canonical link (SEO): Story settings -> Advanced settings ->
   "This story was originally published elsewhere" -> https://jaimeyan.com/blog/fine-tuning-small-llms-admiral-r.html
5. Tags (Medium allows 5): fine-tuning, lora, admiral, adam, small-llms
6. Preview, then Publish.

## Alternative: importer (fast, but no table fidelity)

- https://medium.com/p/import with https://jaimeyan.com/blog/fine-tuning-small-llms-admiral-r.html — sets canonical
  automatically, but Medium flattens HTML tables; prefer the paste path above
  for this series.

---

Canonical: https://jaimeyan.com/blog/fine-tuning-small-llms-admiral-r.html
...
Figure: [End-to-end fine-tuning pipeline](https://jaimeyan.com/figures/fine-tuning-small-llms-admiral-r-pipeline.svg)
...
Full methodology, training configuration, and the validation framework are in the [full paper](https://jaimeyan.com/papers/phuse-2025-os08.html), presented at PhUSE US Connect 2025.
