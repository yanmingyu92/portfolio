---
title: "Synthetic ADaM That Survives a Join: Knowledge Graphs, LLMs, Faker"
date: 2026-08-10
description: "Schema-only synthetic ADaM generation plateaus at 0.45 overall quality; enriching schemas from protocol/SAP/CRF knowledge graphs plus templates reaches 0.70."
tags: ["synthetic-data", "adam", "knowledge-graphs", "llm", "statistical-programming"]
kind: deep-dive
canonicalPath: /blog/synthetic-adam-datasets-llm-knowledge-graph.html
paperRef: phuse-2025-ml12
---
...
![Four-stage pipeline: specs to JSON, schema enhancement with knowledge enrichment and structure optimization, ADSL-first Faker generation, evaluation](/figures/synthetic-adam-datasets-llm-knowledge-graph-pipeline.svg)
