---
title: "CDISC CORE Explained: Open-Source Validation for SDTM/ADaM Programmers"
date: 2026-08-30
description: "CDISC CORE is a free, open-source rule engine for SDTM and ADaM validation. How its YAML rules work, how to run it, and where rule-based checking stops."
tags: ["cdisc-core", "sdtm", "adam", "clinical-data-validation", "open-source"]
kind: explainer
canonicalPath: /blog/cdisc-core-validation-explained.html
---
