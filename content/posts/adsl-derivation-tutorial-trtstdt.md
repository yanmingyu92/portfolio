---
title: "ADSL Derivation Walkthrough: TRT01SDT, Flags, and the Merge Traps"
date: 2026-08-31
description: "How ADSL is built: deriving treatment dates and population flags from DM/EX/DS/SV, the one-row-per-subject rule, and the QC checks that catch real discrepancies."
tags: ["clinical-sas", "adam", "adsl", "cdisc"]
kind: tutorial
